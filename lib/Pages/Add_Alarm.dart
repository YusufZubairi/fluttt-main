    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () {
              // Get the alarmprovider from the context
              final alarmProvider = context.read<alarmprovider>();

              Random random = Random();
              int randomNumber = random.nextInt(100);

              // Set the alarm using the alarmprovider
              alarmProvider.SetAlaram(controller.text, dateTime!, true, name!,
                  randomNumber, Milliseconds!);
              alarmProvider.SetData();
              alarmProvider.SecduleNotification(
